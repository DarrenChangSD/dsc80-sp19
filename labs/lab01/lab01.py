...
def arr_4(A):
    """
    arr_4 takes in an array of stock prices per share
    and returns the total number of days after which the
    'left-over' money from each day can finally be used to purchase a stock.
    Note the first stock is purchased on day *zero*.
